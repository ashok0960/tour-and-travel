    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('booking_date', models.DateTimeField(auto_now_add=True, validators=[bookings.models.validate_not_past])),
                ('travel_date', models.DateField(auto_now_add=True, validators=[bookings.models.validate_not_past])),
                ...
                ('payment_status', models.CharField(choices=[('pending', 'Pending Payment'), ('paid', 'Paid'), ('failed', 'Payment Failed'), ('refunded', 'Refunded')], default='pending', max_length=10)),
